    ...
    <Center>
      <Card
        style={{
          ...
          backgroundColor: "#9ACD32", // Card background color
          color: "white",
          padding: "20px",
        }}
      >
        <Card.Body>
          ...
          <Form onSubmit={passwordReset}>
            ...
            <Button
              ...
              style={{
                width: "100%",
                backgroundColor: "#008000", // Button color (lighter dark ash)
                color: "white",
                border: "none",
                borderRadius: "10px",
                padding: "10px",
          ...
          <div className="w-100 text-center mt-3">
            <Link
              ...
              style={{
                ...
                fontSize: "16px",
                padding: "10px",
                backgroundColor: "#9ACD32", // Background color to match the card
                borderRadius: "10px",
