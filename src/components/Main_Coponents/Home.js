...
function Home() {
  ...
  if (isLoading) {
    return (
      <>
        <Navbar />
        <Container fluid className="text-center mt-5" style={{ marginLeft: "250px" }}>
  ...
  return (
    <>
      <Navbar />
      <Container fluid style={{ marginLeft: "250px" }}> {/* Add left margin here */}
        <div className="d-flex  align-items-center mb-3">
          <FolderBreadcrumbs currentFolder={folder} />
        </div>
        <div className="d-flex  align-items-center mb-3" style={{ marginLeft: "250px" }}>
